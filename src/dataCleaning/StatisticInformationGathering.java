...
import dataPreparation.DatabaseController;

public class StatisticInformationGathering {
	private static final Logger logger = LogManager.getLogger(StatisticInformationGathering.class);
